        ...
        <div class="products">
            ...
            <div class="col-sm-8">
                ...
                <table class="table">
                    ...
                    <tr><td>Macintosh PC</td><td>With a 1.1 Ghz processor and 512Kb Memory, desktop processing is simplistic and easy</td><td><a href="productInfo.php?product_id=macintosh_1" class="productPic"><img src="pics/macintosh1.jpeg" width="50px" height="50px"></a></td><td>$1,237.74</td></tr>
                    <tr><td>Imac PC</td><td>Featuring a 2 Ghz, Dual-core processor, this one takes server computing to the next level</td><td><a href="productInfo.php?product_id=macintosh_2" class="productPic"><img src="pics/macintosh2	.jpg" width="50px" height="50px"></a></td><td>$1,237.74</td></tr>
                    <tr><td>Commadore Amiga</td><td>The future of graphic intense applications</td><td><a href="productInfo.php?product_id=amiga" class="productPic"><img src="pics/amiga.jpg" width="50px" height="50px"></a></td><td>$1,556.01</td></tr>
                    <tr><td>IBM Desktop</td><td>Utilizing hardware and software that took NASA to the moon</td><td><a href="productInfo.php?product_id=ibm" class="productPic"><img src="pics/ibm.jpg" width="50px" height="50px"></a></td><td>$2,300.11</td></tr>
                    <tr><td>Sony Vaio Laptop</td><td>Sexy, sleek, simplistic. This laptop gives you power in your pocket</td><td><a href="productInfo.php?product_id=sony" class="productPic"><img src="pics/sony.png" width="50px" height="50px"></a></td><td>$898.71</td></tr>
                    <tr><td>Rack Server</td><td>Turn your small business into a modern-day Turing machine and never look back</td><td><a href="productInfo.php?product_id=server" class="productPic"><img src="pics/server.jpg" width="50px" height="50px"></a></td><td>$7,019.33</td></tr>
